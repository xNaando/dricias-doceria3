...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-gradient-primary pt-20">
      <div className="absolute top-20 right-10 w-72 h-72 bg-primary-200 rounded-full blur-3xl opacity-30" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-accent-200 rounded-full blur-3xl opacity-30" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#products" className="btn-secondary flex items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-3 gap-6 pt-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600">Artesanal</div>
                <div className="text-sm text-gray-600">feito com carinho</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600">Sob encomenda</div>
                <div className="text-sm text-gray-600">do jeitinho que você quer</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600">Entrega/retirada</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-8 top-1/4 bg-white rounded-2xl shadow-xl p-4">
